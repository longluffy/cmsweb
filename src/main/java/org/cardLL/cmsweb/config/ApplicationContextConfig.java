...
@Configuration
@ComponentScan("org.cardLL.cmsweb.*")
...
//	private CardProcessDAO cardProcessDAO;
	...
	@Transactional
	@Bean
	public CardProcessDAO cardProcessDAO() {
		return new CardProcessDAO();
	}
...
//	}
	...
	public SessionFactory getSessionFactory(DataSource dataSource) throws Exception {
		...
		try {
			...
			factoryBean.setPackagesToScan(new String[] { "org.cardLL.cmsweb.entity" });
